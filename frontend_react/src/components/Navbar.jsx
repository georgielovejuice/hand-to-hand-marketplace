  ...
  return (
    ...
    <div className='navbar bg-[rgb(255,202,141)] shadow-md justify-between px-6'>
        ...
        <div className='flex'>
            ...
            <div className="px-3 py-2 text-md text-black text-lg hover:underline transition hover:bg-orange-700"><Link to="/">Marketplace</Link></div>
            ...
            <div className="px-3 py-2 text-md text-black text-lg hover:underline transition hover:bg-orange-700"><Link to="/profile">Profile</Link></div>
